    ...
    <div className="mx-auto max-w-2xl">
      ...
      <section className="mb-6">
        ...
        <ul className="flex flex-col gap-2 text-sm text-grey-600">
          <li><strong>Age restriction:</strong> You must be at least 16 years old to use Social Olympics.</li>
          <li><strong>No payment processing:</strong> Social Olympics does not handle, hold, or transfer money.</li>
          <li><strong>Data storage:</strong> Your data is stored securely on Supabase infrastructure under GDPR.</li>
          <li><strong>Your rights:</strong> You have the right to access, correct, and delete your personal data at any time.</li>
        </ul>
      </section>
      <section>
        ...
        <p className="text-sm text-grey-600">
          ...
          <span className="font-medium text-grey-800">privacy@socialolympics.app</span>
        </p>
      </section>
    </div>
  );
